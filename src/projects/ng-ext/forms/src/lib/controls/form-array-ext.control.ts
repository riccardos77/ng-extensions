...
export class FormArrayExt
  ...
  public get c(): TControl[] { return this.controls as TControl[]; }
  public get rv(): TValueArray { return this.getRawValue() as TValueArray; }
  public get v(): TValueArray { return this.value; }
